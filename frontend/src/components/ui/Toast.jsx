        ...
        <AnimatePresence>
          {toasts.map(t => (
            <motion.div
              ...
              className={`pointer-events-auto flex items-center gap-3 px-5 py-3.5 rounded-2xl border shadow-float max-w-sm ${colors[t.type]}`}
            >
              <span className={`flex-shrink-0 w-7 h-7 rounded-xl flex items-center justify-center ${iconColors[t.type]}`}>
                {icons[t.type]}
              </span>
