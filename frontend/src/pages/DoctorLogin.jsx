...
import { FiArrowRight, FiShield, FiMail, FiLock, FiLoader } from 'react-icons/fi';
      ...
      <FadeInUp>
        <div className="w-full max-w-sm relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-surface-500 mt-2">Access patient records securely</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/60 shadow-card p-6 sm:p-7 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="text-[13px] font-semibold text-surface-600 mb-2 block">Email</label>
              ...
              <div>
                <label className="text-[13px] font-semibold text-surface-600 mb-2 block">Password</label>
                <div className="relative">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                disabled={loading}
                className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-surface-800 to-surface-900 text-white text-sm font-bold shadow-lg shadow-surface-900/15 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
              >
