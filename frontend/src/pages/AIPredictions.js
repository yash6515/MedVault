...
const RiskBadge = ({ percentage }) => {
  if (percentage >= 60) return (
    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-red-500/10 border border-red-200/50">
      ...
      <span className="text-[10px] font-extrabold text-red-600 uppercase tracking-wide">High Risk</span>
    </span>
  );
  if (percentage >= 35) return (
    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-200/50">
      ...
      <span className="text-[10px] font-extrabold text-amber-600 uppercase tracking-wide">Moderate</span>
    </span>
  );
  return (
    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-200/50">
      ...
      <span className="text-[10px] font-extrabold text-emerald-600 uppercase tracking-wide">Low Risk</span>
    </span>
  );
};
...
const SectionHeader = ({ icon: Icon, title, subtitle, gradient, delay = 0 }) => (
  ...
  >
    ...
    <div>
      <h3 className="text-base font-extrabold text-surface-900 tracking-tight">{title}</h3>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-6 pb-16">
        ...
        {!predictions && !loading && (
          ...
          >
            ...
            <h2 className="text-2xl font-black text-surface-900 mb-3 relative z-10">Analyze Your Health Profile</h2>
                ...
                >
                  ...
                  <div className="grid lg:grid-cols-5 gap-5">
                    ...
                    <div className="lg:col-span-2 rounded-3xl bg-white/70 backdrop-blur-sm border border-surface-200/40 p-8 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-card transition-shadow duration-300">
                      ...
                      <p className="text-lg font-extrabold text-surface-900 mt-5">Overall Health Risk</p>
