      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <FadeInUp>
          <div className="w-full max-w-md">
            <div className="mb-8">
              <h1 className="text-2xl font-extrabold text-surface-950 tracking-tight">Create your Health ID</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input className="input" name="phone" value={form.phone} onChange={handleChange} required placeholder="+91 98765 43210" />
                </div>
              </div>
